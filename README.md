...
This repository contains the latest version of Laravel 4.2. It is used as a reference by [Laravel Shift - the automated way to upgrade Laravel](https://laravelshift.com).
